...
CREATE TABLE IF NOT EXISTS IMAGEN_HOME_KERA(
	id_imagen INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
    tipo_lang CHAR(2),
    titulo_imagen VARCHAR(100) NOT NULL,
    imagen TEXT NULL,
    flag_imagen VARCHAR(10) DEFAULT 'Activo'
)ENGINE = INNODB DEFAULT CHAR SET= UTF8;

-- CREATE TABLE IF NOT EXISTS IMAGEN_HOME_KERA_INGLES(
-- 	id_imagen INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
--     titulo_imagen_en VARCHAR(100) NOT NULL,
--     imagen_en TEXT NULL,
--     flag_imagen_en VARCHAR(10) DEFAULT 'Activo'
-- )ENGINE = INNODB DEFAULT CHAR SET= UTF8;

-- CREATE TABLE IF NOT EXISTS IMAGEN_HOME_KERA_RUSO(
-- 	id_imagen INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
--     titulo_imagen_ru VARCHAR(100) NOT NULL,
--     imagen_ru TEXT NULL,
--     flag_imagen_ru VARCHAR(10) DEFAULT 'Activo'
-- )ENGINE = INNODB DEFAULT CHAR SET= UTF8;

-- CREATE TABLE IF NOT EXISTS IMAGEN_HOME_KERA_FRANCES(
-- 	id_imagen INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
--     titulo_imagen_fr VARCHAR(100) NOT NULL,
--     imagen_fr TEXT NULL,
--     flag_imagen_fr VARCHAR(10) DEFAULT 'Activo'
-- )ENGINE = INNODB DEFAULT CHAR SET= UTF8;
