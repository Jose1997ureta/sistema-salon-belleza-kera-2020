...
CREATE TABLE IF NOT EXISTS PRODUCTO_KERA_ESPANOL (
    ...
    tipo_lang_es CHAR(2) DEFAULT 'es',
...
CREATE TABLE IF NOT EXISTS PRODUCTO_KERA_INGLES (
	id_producto INT NOT NULL,
    tipo_lang_en CHAR(2) DEFAULT 'en',
...
CREATE TABLE IF NOT EXISTS PRODUCTO_KERA_RUSO (
	id_producto INT NOT NULL,
    tipo_lang_ru CHAR(2) DEFAULT 'ru',
...
CREATE TABLE IF NOT EXISTS PRODUCTO_KERA_FRANCES (
	id_producto INT NOT NULL,
    tipo_lang_fr CHAR(2) DEFAULT 'fr',
...
-- ALTER TABLE PRODUCTO_KERA_ESPANOL ADD COLUMN tipo_lang_es CHAR(2) DEFAULT 'es' AFTER id_producto;
-- ALTER TABLE PRODUCTO_KERA_INGLES ADD COLUMN tipo_lang_en CHAR(2) DEFAULT 'en' AFTER id_producto;
-- ALTER TABLE PRODUCTO_KERA_RUSO ADD COLUMN tipo_lang_ru CHAR(2) DEFAULT 'ru' AFTER id_producto;
-- ALTER TABLE PRODUCTO_KERA_FRANCES ADD COLUMN tipo_lang_fr CHAR(2) DEFAULT 'fr' AFTER id_producto;

INSERT INTO TRABAJADOR_KERA(NOMBRE_TRABAJADOR,APELLIDO_TRABAJADOR,CORREO_TRABAJADOR,PASSWORD_TRABAJADOR) VALUES('Admin1','Admin2','admin@gmail.com','admin123')