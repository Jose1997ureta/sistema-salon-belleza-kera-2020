...
CREATE PROCEDURE LISTAR_IMAGEN_PRODUCTO(
    ...
    BEGIN
        SELECT I.ID_IMAGEN,PES.NOMBRE_PRODUCTO_ES,I.IMAGEN_PRODUCTO FROM IMAGEN_PRODUCTO_KERA I INNER JOIN PRODUCTO_KERA_ESPANOL PES ON PES.ID_PRODUCTO = I.ID_PRODUCTO WHERE ID_PRODUCTO = _ID_PRODUCTO;
    END;
$
