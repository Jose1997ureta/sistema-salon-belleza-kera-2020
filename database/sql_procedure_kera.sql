...
CREATE PROCEDURE LISTAR_IMAGEN_HOME_LANG(
    ...
    BEGIN
        SELECT TIPO_LANG,TITULO_IMAGEN,IMAGEN,RUTA_IMAGEN FROM IMAGEN_HOME_KERA WHERE TIPO_LANG = _TIPO_LANG;
    END;
$
...
CREATE PROCEDURE REGISTRAR_IMAGEN_HOME(
    ...
    BEGIN
        INSERT INTO IMAGEN_HOME_KERA(TIPO_LANG,TITULO_IMAGEN,IMAGEN,RUTA_IMAGEN) VALUES(_TIPO_LANG,_TITULO_IMAGEN,_IMAGEN,_RUTA_IMAGEN);   
    END;
$
...
CREATE PROCEDURE ACTUALIZAR_IMAGEN_HOME(
    ...
    BEGIN
        UPDATE IMAGEN_HOME_KERA SET TITULO_IMAGEN = _TITULO_IMAGEN, IMAGEN =_IMAGEN, RUTA_IMAGEN = _RUTA_IMAGEN WHERE ID_IMAGEN = _ID_IMAGEN;
    END;
$
