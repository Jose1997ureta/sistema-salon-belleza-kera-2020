...
CREATE PROCEDURE LISTAR_PRODUCTO()
    BEGIN
        SELECT P.ID_PRODUCTO,PE.TIPO_PRODUCTO_ES,PE.NOMBRE_PRODUCTO_ES,P.IMAGEN_RESULTADO,P.FLAG_PRODUCTO FROM PRODUCTO_KERA P INNER JOIN PRODUCTO_KERA_ESPANOL PE ON P.ID_PRODUCTO=PE.ID_PRODUCTO GROUP BY P.ID_PRODUCTO ORDER BY P.ID_PRODUCTO DESC;
    END;
$
...
CREATE PROCEDURE LISTAR_PRODUCTO_DETALLE(
    ...
    END;
$
CALL LISTAR_PRODUCTO_DETALLE('1')
