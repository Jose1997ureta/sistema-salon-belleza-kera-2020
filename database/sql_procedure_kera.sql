...
CREATE PROCEDURE LISTAR_IMAGEN_HOME_LANG(
    ...
    END;
$
SELECT P.ID_PRODUCTO,P.TIPO_LANG_ES,P.TIPO_PRODUCTO_ES,P.NOMBRE_PRODUCTO_ES,I.IMAGEN FROM PRODUCTO_KERA_ESPANOL P LEFT JOIN IMAGEN_PRODUCTO_KERA I ON P.ID_PRODUCTO=I.ID_PRODUCTO GROUP BY P.ID_PRODUCTO;
