...
CREATE PROCEDURE LISTAR_PRODUCTO_DETALLE(
    ...
    END;
$
SELECT PE.*,P.IMAGEN_RESULTADO,P.RUTA_VIDEO FROM PRODUCTO_KERA_ESPANOL PE INNER JOIN PRODUCTO_KERA P ON P.ID_PRODUCTO = PE.ID_PRODUCTO WHERE P.ID_PRODUCTO = 1 GROUP BY P.ID_PRODUCTO
