    ...
    <div class="row">
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    <form class="needs-validation" id="form-actualizar-producto" autocomplete="off" novalidate>
                        <div class="form-row form-group">
                            <div class="col-md-12 form-group">
                                <label for="categoriaProducto">Categoría:</label>
                                <select class="form-control-sm form-control" disabled required name="categoriaProducto"
                            ...
                            <div class="col-md-4 col-sm-4 form-group">
                                ...
                                <input type="checkbox" class="d-block" name="nombreCheckboxNuevo"
                                    id="nombreCheckboxNuevo">
                            </div>
                            <div class="col-md-4 col-sm-4 form-group">
                                <label for="nombreCheckboxNuevo">Estado:</label>
                                <input type="checkbox" class="d-block" name="chkEstadoProducto"
                                    id="chkEstadoProducto">
                            </div>
